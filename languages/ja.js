module.exports = {
    ...
    playlist: {
        playlist: {
            command: {
                name: "playlist",
                description: "プレイリストメニューを開く"
            },
            title: "プレイリストメニュー",
            description: "下のボタンでプレイリストを管理します。",
            createLabel: "プレイリスト作成",
            createDescription: "名前モーダルを開いて新しいプレイリストを保存します。",
            addLabel: "曲を追加",
            addDescription: "プレイリストにカンマ区切りの曲やURLを追加します。",
            viewLabel: "プレイリストを表示",
            viewDescription: "保存されたプレイリストを即座に再生します。",
            playLabel: "プレイリストを表示",
            playDescription: "プレイリストを開いて再生するものを選択します。",
            viewSongsLabel: "プレイリストの曲を表示",
            viewSongsDescription: "プレイリスト内の曲を閲覧します。",
            deleteLabel: "プレイリスト削除",
            deleteDescription: "個人ライブラリからプレイリストを削除します。",
            noPlaylistsTitle: "## ❌ プレイリストが見つかりません",
            noPlaylistsMessage: "まだプレイリストがありません。まず**プレイリスト作成**で作成してください。",
            noPlaylistsNote: "プレイリスト作成ボタンを使用して開始します。",
            selectionPrompt: "下のボタンからプレイリストを選択してください。",
            addPrompt: "曲を追加するプレイリストを選択してください。",
            playPrompt: "再生するプレイリストを選択してください。",
            songsPrompt: "曲を表示するプレイリストを選択してください。",
            deletePrompt: "削除するプレイリストを選択してください。",
            listStatus: "フィルター後{filtered}件（全{total}件）のうち{shown}件を表示しています。",
            listLimitNote: "ここでは最初の{max}個のプレイリストのみ表示されます。古いプレイリストを削除または名前変更してさらに表示します。",
            pageStatus: "ページ {current}/{total}",
            noFilteredPlaylists: "このフィルターに一致するプレイリストはありません。別の範囲か「すべて」を選択してください。",
            allFilterLabel: "すべて",
            ...
            filterMRLabel: "M-R",
            filterSZLabel: "S-Z",
            processingTitle: "プレイリスト処理中",
            processingMessage: "プレイリスト**{name}**を準備し、トラックを解決しています。お待ちください...",
            createModalTitle: "プレイリスト作成",
            playlistNameLabel: "プレイリスト名",
            playlistNamePlaceholder: "お気に入りのトラック",
            addSongsModalTitle: "{name}に曲を追加",
            songsInputLabel: "曲またはURL（カンマ区切り）",
            songsInputPlaceholder: "曲1, 曲2, https://youtu.be/xyz",
            invalidPlaylistNameTitle: "## ❌ 無効なプレイリスト名",
            invalidPlaylistNameMessage: "有効なプレイリスト名を入力してください。",
            playlistExistsTitle: "## ❌ プレイリストは既に存在します",
            playlistExistsMessage: "ライブラリに**\"{name}\"**という名前のプレイリストが既に存在します。",
            playlistCreatedTitle: "## ✅ プレイリスト作成済み",
            playlistCreatedMessage: "プレイリスト**\"{name}\"**が正常に作成されました。",
            noSongsFoundTitle: "## ❌ 曲が見つかりません",
            noSongsFoundMessage: "カンマで区切られた1つ以上の曲名またはURLを追加してください。",
            playlistNotFoundTitle: "## ❌ プレイリストが見つかりません",
            playlistNotFoundMessage: "そのプレイリストが見つからないか、削除された可能性があります。",
            songsAddedTitle: "## ✅ 曲を追加しました",
            songsAddedMessage: "**{count}**曲を**\"{name}\"**に追加しました。",
            emptyPlaylistTitle: "## ❌ 空のプレイリスト",
            emptyPlaylistMessage: "プレイリスト**\"{name}\"**にはまだ曲がありません。まず曲を追加してください。",
            songsViewTitle: "プレイリストの曲",
            songsViewStatus: "{total}曲中 {start}-{end} を表示しています。",
            songsEmptyTitle: "## ❌ プレイリストに曲がありません",
            songsEmptyMessage: "プレイリスト**\"{name}\"**にはまだ曲がありません。",
            backToPlaylistsLabel: "プレイリスト一覧に戻る",
            voiceChannelErrorTitle: "## ❌ ボイスチャンネルエラー",
            voiceChannelErrorMessage: "ボイスチャンネルに参加できません。",
            lavalinkUnavailableTitle: "## ❌ Lavalink利用不可",
            lavalinkUnavailableMessage: "音楽マネージャーは現在利用できません。後でもう一度お試しください。",
            nodesUnavailableTitle: "## ❌ Lavalink利用不可",
            nodesUnavailableMessage: "現在、音楽を再生するためのノードが利用できません。後でもう一度お試しください。",
            playbackErrorTitle: "## ❌ 再生エラー",
            playbackErrorMessage: "プレイリスト内の1つ以上の曲を解決できませんでした。プレイリストの内容を確認してください。",
            playingPlaylistTitle: "プレイリスト再生中",
            playingPlaylistLineStatus: "**{count}**曲をキューに追加しました。",
            playlistDeletedTitle: "## ✅ プレイリスト削除済み",
            playlistDeletedMessage: "プレイリストは正常に削除されました。",
            backLabel: "メニューに戻る",
            addHeading: "曲を追加",
            viewHeading: "プレイリストを表示",
            playHeading: "プレイリストを表示",
            songsHeading: "プレイリストの曲を表示",
            deleteHeading: "プレイリストを削除",
            deleteNote: "プレイリストボタンをクリックして永久に削除します。"
        },
        createplaylist: {
            command: {
                name: "createplaylist",
