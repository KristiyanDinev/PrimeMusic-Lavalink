module.exports = {
    ...
    playlist: {
        playlist: {
            command: {
                name: "playlist",
                description: "플레이리스트 메뉴 열기"
            },
            title: "플레이리스트 메뉴",
            description: "아래 버튼으로 플레이리스트를 관리하세요.",
            createLabel: "플레이리스트 만들기",
            createDescription: "이름 모달을 열고 새 플레이리스트를 저장합니다.",
            addLabel: "노래 추가",
            addDescription: "플레이리스트에 쉼표로 구분된 노래나 URL을 추가합니다.",
            viewLabel: "플레이리스트 보기",
            viewDescription: "저장된 플레이리스트를 즉시 재생합니다.",
            playLabel: "플레이리스트 보기",
            playDescription: "플레이리스트를 열고 재생할 항목을 선택합니다.",
            viewSongsLabel: "플레이리스트 곡 보기",
            viewSongsDescription: "플레이리스트 안의 곡을 확인합니다.",
            deleteLabel: "플레이리스트 삭제",
            deleteDescription: "개인 라이브러리에서 플레이리스트를 제거합니다.",
            noPlaylistsTitle: "## ❌ 플레이리스트를 찾을 수 없음",
            noPlaylistsMessage: "아직 플레이리스트가 없습니다. 먼저 **플레이리스트 만들기**로 만드세요.",
            noPlaylistsNote: "플레이리스트 만들기 버튼을 사용하여 시작하세요.",
            selectionPrompt: "아래 버튼에서 플레이리스트를 선택하세요.",
            addPrompt: "노래를 추가할 플레이리스트를 선택하세요.",
            playPrompt: "재생할 플레이리스트를 선택하세요.",
            songsPrompt: "곡을 볼 플레이리스트를 선택하세요.",
            deletePrompt: "삭제할 플레이리스트를 선택하세요.",
            listStatus: "필터된 플레이리스트 {filtered}개(전체 {total}개) 중 {shown}개를 표시합니다.",
            listLimitNote: "여기서는 처음 {max}개 플레이리스트만 표시됩니다. 더 보려면 오래된 플레이리스트를 삭제하거나 이름을 바꾸세요.",
            pageStatus: "페이지 {current}/{total}",
            noFilteredPlaylists: "이 필터와 일치하는 플레이리스트가 없습니다. 다른 범위를 선택하거나 전체를 선택하세요.",
            allFilterLabel: "전체",
            ...
            filterMRLabel: "M-R",
            filterSZLabel: "S-Z",
            processingTitle: "플레이리스트 처리 중",
            processingMessage: "플레이리스트 **{name}**을(를) 준비하고 트랙을 해결하는 중입니다. 잠시 기다려주세요...",
            createModalTitle: "플레이리스트 만들기",
            playlistNameLabel: "플레이리스트 이름",
            playlistNamePlaceholder: "내가 좋아하는 트랙",
            addSongsModalTitle: "{name}에 노래 추가",
            songsInputLabel: "노래 또는 URL (쉼표로 구분)",
            songsInputPlaceholder: "노래 1, 노래 2, https://youtu.be/xyz",
            invalidPlaylistNameTitle: "## ❌ 잘못된 플레이리스트 이름",
            invalidPlaylistNameMessage: "유효한 플레이리스트 이름을 입력하세요.",
            playlistExistsTitle: "## ❌ 플레이리스트가 이미 존재함",
            playlistExistsMessage: "라이브러리에 **\"{name}\"**이라는 이름의 플레이리스트가 이미 존재합니다.",
            playlistCreatedTitle: "## ✅ 플레이리스트 생성됨",
            playlistCreatedMessage: "플레이리스트 **\"{name}\"**이(가) 성공적으로 생성되었습니다.",
            noSongsFoundTitle: "## ❌ 노래를 찾을 수 없음",
            noSongsFoundMessage: "쉼표로 구분된 하나 이상의 노래 이름이나 URL을 추가하세요.",
            playlistNotFoundTitle: "## ❌ 플레이리스트를 찾을 수 없음",
            playlistNotFoundMessage: "해당 플레이리스트를 찾을 수 없거나 삭제되었을 수 있습니다.",
            songsAddedTitle: "## ✅ 노래 추가됨",
            songsAddedMessage: "**{count}**곡을 **\"{name}\"**에 추가했습니다.",
            emptyPlaylistTitle: "## ❌ 빈 플레이리스트",
            emptyPlaylistMessage: "플레이리스트 **\"{name}\"**에는 아직 노래가 없습니다. 먼저 노래를 추가하세요.",
            songsViewTitle: "플레이리스트 곡",
            songsViewStatus: "총 {total}곡 중 {start}-{end}번을 표시합니다.",
            songsEmptyTitle: "## ❌ 플레이리스트에 곡이 없습니다",
            songsEmptyMessage: "플레이리스트 **\"{name}\"**에는 아직 노래가 없습니다.",
            backToPlaylistsLabel: "플레이리스트 목록으로",
            voiceChannelErrorTitle: "## ❌ 음성 채널 오류",
            voiceChannelErrorMessage: "음성 채널에 참여할 수 없습니다.",
            lavalinkUnavailableTitle: "## ❌ Lavalink 사용 불가",
            lavalinkUnavailableMessage: "음악 관리자가 현재 사용할 수 없습니다. 나중에 다시 시도하세요.",
            nodesUnavailableTitle: "## ❌ Lavalink 사용 불가",
            nodesUnavailableMessage: "현재 음악을 재생할 노드가 없습니다. 나중에 다시 시도하세요.",
            playbackErrorTitle: "## ❌ 재생 오류",
            playbackErrorMessage: "플레이리스트의 하나 이상의 노래를 해결할 수 없습니다. 플레이리스트 내용을 확인하세요.",
            playingPlaylistTitle: "플레이리스트 재생 중",
            playingPlaylistLineStatus: "**{count}**곡을 대기열에 추가했습니다.",
            playlistDeletedTitle: "## ✅ 플레이리스트 삭제됨",
            playlistDeletedMessage: "플레이리스트가 성공적으로 제거되었습니다.",
            backLabel: "메뉴로 돌아가기",
            addHeading: "노래 추가",
            viewHeading: "플레이리스트 보기",
            playHeading: "플레이리스트 보기",
            songsHeading: "플레이리스트 곡 보기",
            deleteHeading: "플레이리스트 삭제",
            deleteNote: "플레이리스트 버튼을 클릭하여 영구적으로 삭제합니다."
        },
        createplaylist: {
            command: {
                name: "createplaylist",
